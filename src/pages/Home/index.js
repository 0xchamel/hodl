...
const HomePage = () => {
    ...
    return (
        <div className="home">
            ...
            <div className="home__inf">
                <p><span>Dragon’s Vault</span> is&nbsp;a&nbsp;globally distributed investment portfolio composed of&nbsp;crypto-assets and venture capital. Our family of&nbsp;funds are optimized for<br></br> high-risks/high-returns and shielded against localized financial crisis and currency devaluation of&nbsp;specific regions of&nbsp;the world.</p>
                <img src={decor_1} alt="" />
            </div>
                    ...
                    <div className="home__portfolio-box">
                        {
                            portfolio.map((card, index) => {
                                return <Link key={index} to={`/${card.link}`} className="home__portfolio-card">
                                    <div className={classNames('home__portfolio-card-box', {
                                        'home__portfolio-card-box--reverse': index % 2
                                    })}>
                                        <img src={require(`../../assets/img/portfolio/${index + 1}.jpg`)} alt="" className="home__portfolio-card-bg" />
