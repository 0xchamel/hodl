			...
			<div className="crypto__banner">
				<div className="row">
					...
					<div className="crypto__banner--description">
						...
						crypto-assets such as <span>HODLC</span>, and <span>Axion</span>, as well as launched our own
						internal projects: PSAT, HSTAKE.
					</div>
				</div>
			</div>
					...
					<div className="row crypto__info--row">
						<div className="crypto__info--content">
							...
							<div className="crypto__info--text text__right">
                                ...
                                <br />
                                <br />
                                As well, PSAT will be the token of
								choice for Dragon’s Vault future project as a payment solution, i.e. new tokens will be
								sold first in exchange for PSAT. As well, PSAT will be the medium of choice in HSTAKE as
								a payment option for the passive source of income from the staking mechanism.
							</div>
						</div>
					...
					<div className="row crypto__info--row">
						...
						<div className="crypto__info--content">
							...
							<div className="crypto__info--text text__left">
								...
								increasing normally, and stakers no longer have to sell HODLC in order to obtain fiat,
								they can simply sell the PSAT they receive periodically.
							</div>
						</div>
					</div>
				</div>
